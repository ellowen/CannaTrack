-- CannaTrack: EXECUTE ALL MIGRATIONS IN SEQUENCE
-- Run this entire file in Supabase SQL Editor to set up the complete schema
-- (Copy-paste entire content into https://supabase.com/dashboard/project/[your-ref]/sql/new)

-- ════════════════════════════════════════════════════════════════════════════
-- MIGRATION 01: Base Schema (profiles, plants, tasks, measurements, photos)
-- ════════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════════
-- MIGRATION 02: Nutrition Tables Schema
-- ════════════════════════════════════════════════════════════════════════════
...
comment on table nutrition_tables is 'Tablas nutricionales por marca (Revegetar, Advanced Nutrients, etc.)';
...
comment on table nutrition_weeks is 'Semanas por fase (vege/flora) con rango EC/pH';
...
comment on table nutrition_products is 'Productos por semana de la tabla nutricional';
...
-- Seed REVEGETAR table (14 weeks: 6 VEGE + 8 FLORA)
...
-- ════════════════════════════════════════════════════════════════════════════
-- MIGRATION 03: Gamification Schema
-- ════════════════════════════════════════════════════════════════════════════
...
comment on table user_xp_log is 'Registro de XP ganado por acciones';
...
-- Función: Calcular información de nivel
...
begin
  ...
  -- Calcular XP según tipo de tarea
...
-- ════════════════════════════════════════════════════════════════════════════
-- MIGRATION 04: RLS Policies (Additional)
-- ════════════════════════════════════════════════════════════════════════════
...
-- VERIFICATION QUERY
-- ════════════════════════════════════════════════════════════════════════════
-- Run this query after migrations complete to verify schema:
-- SELECT count(*) as table_count FROM information_schema.tables WHERE table_schema = 'public';
-- Expected result: 13 tables (profiles, plants, scheduled_tasks, measurements, week_logs, nutrition_tables, nutrition_weeks, nutrition_products, user_xp_log, user_streaks, + 2 system)
