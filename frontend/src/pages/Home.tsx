...
export default function Home() {
  ...
  const { tasks: allActiveTasks, todayTasks, overdueTasks, completeTask } = useTasks()
      ...
      {isLoading && plants.length === 0 ? (
        ...
        <div className="mb-6">
          ...
          <div className="bg-app-card rounded-3xl border border-app-border overflow-hidden">
            ...
            {/* Completadas del dia */}
            {done.length > 0 && (
              <div className="flex items-center gap-2.5 px-5 py-3 border-t border-app-border bg-app-elevated/50">
