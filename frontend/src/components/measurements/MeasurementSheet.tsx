      ...
      >
        <div className="bg-app-card rounded-t-3xl shadow-card-lg">
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b border-app-border">
            ...
            <button onClick={onClose} aria-label="Cerrar" className="w-8 h-8 rounded-xl bg-app-elevated flex items-center justify-center text-ink-3 tap-highlight-none active:scale-95 transition-all">
